...
var htmlLocalData_CH = {
    title: "2025海產OC神秘禮物投稿表單",
    phase1_summary: "⚠️ 填之前請先跟主持人58確認你有在參加名單中 ⚠️",
    phase2_summray: [
        "這是神秘禮物交換會繪圖企劃的第二部份！",
        "參加者需要根據禮物抽選結果畫自己的OC收到聖誕禮物。"
    ],
    nav: ["開場白", "請問怎麼玩", "參加前必讀", "截止日期", "今年參加者"],
    prologue_content: [
        "有一天，你的OC突然收到了一封神秘的信。",
        "",
        "親愛的海洋生物，",
        "我們是神秘禮物交換組織，在此來通知——你被選中了！",
        "我們專門收集來自各種時空的神秘禮物，並且將這些禮物進行交換。",
        "如果你想參加的話，就準備一個冬季禮物並貼上我們附給你的郵票吧。",
        "參加成功的話，冬季節日那天你也會收到一個別人準備的禮物哦。",
        "<span>P.S.請不要包裝禮物，本組織會幫你包</span>",
        "<span>P.S.請不要把郵票貼在你朋友身上</span>",
        "",
        "",
        "信封上竟然沒有地址也沒有署名，只附了一張看起來充滿奇特力量的郵票。",
        "到底是怎麼寄到這裡的呢？真是太可疑了。",
        "",
        "你的OC到底要不要照著信上的說的做呢？",
        ""
