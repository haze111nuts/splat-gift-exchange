...
function setUpAudios() {
    AUDIO_ELEMENTS["balloonPop"] = createAudioElement(1, assetBaseUrl('sound/splatoon3_obtain.mp3') );
    AUDIO_ELEMENTS["itemObtain"] = createAudioElement(0.15, assetBaseUrl('sound/item_obtain.mp3') );
